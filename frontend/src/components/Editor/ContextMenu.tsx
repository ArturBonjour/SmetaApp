...
import { Trash2, Copy, Edit3, ArrowUp, ArrowDown } from 'lucide-react';
...
export default function ContextMenu({
  ...
  return (
    <div
      ref={menuRef}
      className="fixed z-50 bg-[var(--bg-card)] border border-[var(--border)] rounded-xl shadow-2xl py-1.5 min-w-[180px] animate-in fade-in zoom-in-95 duration-100"
